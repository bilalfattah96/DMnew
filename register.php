        ...
        <div class="row">
            <div class="col-12 col-md-6 bsb-tpl-bg-platinum">
                <div class="d-flex flex-column justify-content-between h-100 p-3 p-md-4 p-xl-5">
                    <h3 class="m-0">Welcome to ByBeauty</h3>
                ...
                <div class="p-3 p-md-4 p-xl-5">
                    ...
                    <form method="post">
                        <div class="row gy-3 gy-md-4 overflow-hidden">
                            <div class="col-12">
                                <label for="username" class="form-label">Userame <span class="text-danger">*</span></label>
                            ...
                            <div class="col-12">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="yes" name="iAgree" id="iAgree" required>
                            ...
                            <div class="col-12">
                                <div class="d-grid">
                                    <input class="btn bsb-btn-xl btn-primary" name="signup" type="submit" value="Register">
                                </div>
                            </div>
                        </div>
                    </form>
